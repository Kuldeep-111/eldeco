  ...
  return (
    <div className="py-[40px] md:py-[50px] bg-white">
      <div className="w-full md:w-[70%] mx-auto">
        ...
        <div className="mb-5 grid gap-[10px] md:gap-10 grid-cols-3">
          {FOOTER_DATA.map((cat) => (
            ...
            <button
              ...
              className={`pb-2  relative ${active === cat.id ? "text-black" : "text-black/40 "} text-sm uppercase tracking-wider transition-all px-[20px] sm:px-[30px]`}
            >
        ...
        {/* Status Grid */}
        <div className="grid grid-cols-1 gap-7 md:gap-10 md:grid-cols-3 px-[10px] md:px-0">
